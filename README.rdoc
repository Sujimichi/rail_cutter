...
== Usage 
  ...
  comment lines out in the add_customization method to change what components are intalled, command line options will be added at some time.
...
= Which will:
  ...
  - setup a welcome contoller and index (and remove public/index.html)
